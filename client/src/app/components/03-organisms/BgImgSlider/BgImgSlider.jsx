  ...
  return (
    <Slider {...settings}>
      {slides.map((slide, index) => (
        <div
          key={index}
          className="w-full h-[93vh] lg:max-h-screen  !flex justify-center items-center pt-20 pb-40 relative z-30 flex-col max-h-[525px] sm:max-h-[650px] max-w-[700px] sm:max-w-full lg:max-w-2/4 "
        >
          <img
            src={slide.image}
            alt=""
